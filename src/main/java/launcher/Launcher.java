...
public class Launcher {
        ...
        while (Constants.MAIN_LOOP) {
            ...
            while (Constants.GAME) {
                ...
                if (sleepGameTime > 0) {
                    try {
                        ...
                        LOGGER.log(Level.SEVERE, "Game while cycle was interrupted!");
                    }
                }
            ...
            if (sleepTime > 0) {
                try {
                    ...
                    LOGGER.log(Level.SEVERE, "UI while cycle was interrupted!");
                }
            }
            mainFrame.updateUserInterface();
        }
    ...
    private static boolean checkSavedGames() {
        ...
        if (folder.exists() && folder.isDirectory()) {
            LOGGER.log(Level.INFO, "Directory for game saves was founded\n");
            ...
            if (folder.mkdir()) {
                LOGGER.log(Level.INFO, "Directory for game saving was created\n");
            }
            else {
                LOGGER.log(Level.SEVERE, "Directory for game saving wasn't created\n");
            }
        }
        return false;
    }
